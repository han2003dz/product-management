...
// [POST] user/info
module.exports.editInfoPost = async (req, res) => {
  const userId = res.locals.user.id;
  const { email, username /*Thêm các trường thông tin khác cần chỉnh sửa*/ } =
    req.body;
  ...
  try {
    ...
    // Cập nhật các trường thông tin khác cần chỉnh sửa
